...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2020 at 08:38 AM
...
CREATE TABLE `buku` (
  `id` int(11) NOT NULL,
  `judul_buku` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_kategori` int(11) NOT NULL,
  `pengarang` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `image` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT 'book-default-cover.jpg'
...
(3, 'PHP Komplet', 1, 'Jubilee', 'Alex Media Komputindo', 2017, '8346753547', 5, 1, 1, 'img1555522493.jpg'),
(4, 'Detektif Konan', 9, 'Okigawa Sasuke', 'Cultura', 2016, '874387583987', 3, 0, 0, 'img1557401465.jpg');
